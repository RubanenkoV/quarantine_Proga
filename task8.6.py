#На еолимпе задача пройти не должна, ибо в ходе решения я использовал defaultdict, а я не думаю, что это предусмотрено в решении, которое ожтдаемо на еолимп.
